...
class UserReviewsView extends StatefulWidget {
  ...
  List<AppUser> users;
  AppUser currentUser;
  UserReviewsView({required this.userReviews, required this.users, required this.currentUser});
...
return empty;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      title: Text("Değerlendirmeler",style: 
      ...
      ListView.builder(
                              ...
                              return Container(
                                ...
                                child: GestureDetector(
                                  onTap: (){
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => ReviewView(myReview:widget.userReviews[index], myUser: widget.currentUser, currentUser: widget.currentUser,)));
                                  },
                                  child: Card(
                                    elevation: 1,
                                    color: Colors.white,
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      margin: EdgeInsets.only(right: MediaQuery.of(context).size.width*0.05),child: Center(child: Text("Henüz Değerlendirme Yok",style: TextStyle(fontFamily: 'Poppins-Regular',color: Colors.black54,fontSize: 15),))),
